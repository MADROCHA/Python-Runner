...
ground_surf = pygame.image.load('graphics/Ground3.png').convert()
ground_rect = ground_surf.get_rect(topright =(815 ,300))
def ground_parallax():
    if ground_rect.x <= -15:
        ground_rect.x = 0
    ground_rect.x += -1
...
#snail1_rect = snail1_surf.get_rect(bottomright = (660,300))
## FLY 1
...
#fly_rect = fly_surf.get_rect(bottomright = (660,300))
...
## Text
game_name_text = test_font.render('Runner',False, (111,196,169))
game_name_text_rect = game_name_text.get_rect(center = (400,50))

game_message_tutorial = test_font.render('Press space to Jump',False,(111,196,169))
game_message_tutorial_rect = game_message_tutorial.get_rect(center = (400,350))
...
while True:
    ...
    if game_active:   
        ...
        ## added ground_rect to move image
        ...
        #screen.blit(snail1_surf,snail1_rect)
        ...
        game_score_message = test_font.render(f'Your Score is: {game_score}',False,(111,196,169))
        game_score_message_rect = game_score_message.get_rect(center = (400,330))
        screen.blit(game_name_text,game_name_text_rect)

        if game_score == 0:
            screen.blit(game_message_tutorial,game_message_tutorial_rect)
        else:
            screen.blit(game_score_message,game_score_message_rect)
